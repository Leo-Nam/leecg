...
function draw() {
  ...
  ctx.font = "16px Arial";
  ctx.textAlign = "left";
  ctx.fillText(`Explodes: ${explodeCount.value} | Collisions: ${collisionCount.value} | biggestMass: ${biggestMass.value} (exploding: ${planets[biggestPlanetIdx.value].exploding}, radius: ${planets[biggestPlanetIdx.value].radius.toFixed(3)})`, 20, canvas.height - 20);
