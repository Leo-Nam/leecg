<template>
	<div>		
		<h1><span class="mhcp" @click="$router.go(-1);">돌아가기</span></h1>
		<h1>Privacy Policy for 가평고 3-6</h1>
		...
		<li>
		<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to 가평고 3-6.</p>
		</li>
		<li>
		...
		<li>
		<p><strong>Website</strong> refers to 가평고 3-6, accessible from <a href="http://127.0.0.1:5500/asfd.html" rel="external nofollow noopener" target="_blank">http://127.0.0.1:5500/asfd.html</a></p>
		</li>
		<li>
		...
		<ul>
		<li>By email: leecg1007007@gmail.com</li>
		</ul>
	</div>
</template>
<script>
